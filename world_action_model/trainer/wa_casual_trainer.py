...
from world_action_model.models import CasualWorldActionTransformer
...
class CasualWATrainer(Trainer):
    def get_models(self, model_config):
        ...
        transformer = CasualWorldActionTransformer(**transformer_cfg)
        transformer = load_pretrained_weights(transformer,transformer_pretrained)
