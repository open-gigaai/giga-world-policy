...
transformer_pretrained = _env_required("GWP0_TRANSFORMER_PRETRAINED")
project_dir = _env("GWP0_PROJECT_DIR", os.path.join("outputs", "gwp0_agilex_finetune"))
...
config = dict(
    runners=['world_action_model.CasualWATrainer'],
